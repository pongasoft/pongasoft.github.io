...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'examples/core_window_letterbox.data';
      var REMOTE_PACKAGE_BASE = 'core_window_letterbox.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_examples/core_window_letterbox.data');

      };
      Module['addRunDependency']('datafile_examples/core_window_letterbox.data');
    ...
    loadPackage({"files": [{"filename": "/resources/LICENSE.md", "start": 0, "end": 346}, {"filename": "/resources/distortion100.fs", "start": 346, "end": 2072}, {"filename": "/resources/distortion330.fs", "start": 2072, "end": 3969}, {"filename": "/resources/ps3.png", "start": 3969, "end": 23249}, {"filename": "/resources/xbox.png", "start": 23249, "end": 39361}], "remote_package_size": 39361});
...
var wasmBinaryFile;
  wasmBinaryFile = 'core_window_letterbox.wasm';
...
var ASM_CONSTS = {
  21568: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 21621: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 21690: () => { return Module.raylib.screenWidth; },  
 21724: () => { return Module.raylib.screenHeight; },  
 21759: () => { console.log("dpr: " + devicePixelRatio); return (typeof devicePixelRatio == 'number' && devicePixelRatio) || 1.0; },  
 21877: ($0, $1) => { GLFW.active.width = $0; GLFW.active.height = $1; },  
 21930: ($0) => { Module.raylib = {}; const cb = Module.requestFullscreen; Module.requestFullscreen = (pointerLock, resize) => { const canvas = document.getElementById('canvas'); Module.raylib.screenWidth = canvas.clientWidth; Module.raylib.screenHeight = canvas.clientHeight; cb(pointerLock, $0); }; Module.onFullscreen = Module.cwrap('FullscreenCallback', null, ['boolean']); Module.setHighDPIAware = Module.cwrap('SetHighDPIAware', null, ['boolean']); }
};
...
var _FullscreenCallback = Module['_FullscreenCallback'] = createExportWrapper('FullscreenCallback');
var _SetHighDPIAware = Module['_SetHighDPIAware'] = createExportWrapper('SetHighDPIAware');
...
var ___start_em_js = Module['___start_em_js'] = 22371;
var ___stop_em_js = Module['___stop_em_js'] = 22444;
