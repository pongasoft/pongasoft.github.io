...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'examples/core_window_flags.data';
      var REMOTE_PACKAGE_BASE = 'core_window_flags.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_examples/core_window_flags.data');

      };
      Module['addRunDependency']('datafile_examples/core_window_flags.data');
...
var wasmBinaryFile;
  wasmBinaryFile = 'core_window_flags.wasm';
...
var ASM_CONSTS = {
  21936: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 21989: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 22058: () => { return Module.raylib.screenWidth; },  
 22092: () => { return Module.raylib.screenHeight; },  
 22127: () => { console.log("dpr: " + devicePixelRatio); return (typeof devicePixelRatio == 'number' && devicePixelRatio) || 1.0; },  
 22245: ($0, $1) => { GLFW.active.width = $0; GLFW.active.height = $1; },  
 22298: ($0) => { Module.raylib = {}; const cb = Module.requestFullscreen; Module.requestFullscreen = (pointerLock, resize) => { const canvas = document.getElementById('canvas'); Module.raylib.screenWidth = canvas.clientWidth; Module.raylib.screenHeight = canvas.clientHeight; cb(pointerLock, $0); }; Module.onFullscreen = Module.cwrap('FullscreenCallback', null, ['boolean']); Module.setHighDPIAware = Module.cwrap('SetHighDPIAware', null, ['boolean']); }
};
...
var ___start_em_js = Module['___start_em_js'] = 22739;
var ___stop_em_js = Module['___stop_em_js'] = 22812;
