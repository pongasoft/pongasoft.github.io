...
// end include: preamble.js
  ...
  var _emscripten_glfw3_context_init = (context, scale, scaleChangeCallback, windowResizeCallback, requestFullscreen, errorHandler) => {
  ...
  var _emscripten_glfw3_context_to_codepoint = (eventKey) => {
  ...
  var _emscripten_glfw3_window_set_cursor = (glfwWindow, cursor) => {
      const ctx = GLFW3.fWindowContexts[glfwWindow];
      if(cursor)
  ...
  var _emscripten_glfw_make_canvas_resizable = (glfwWindow, resizableSelector, handleSelector) => {
...
var wasmImports = {
  ...
  /** @export */
  emscripten_glfw3_context_to_codepoint: _emscripten_glfw3_context_to_codepoint,
  /** @export */
  ...
  /** @export */
  emscripten_glfw3_window_set_cursor: _emscripten_glfw3_window_set_cursor,
  /** @export */
  ...
  /** @export */
  emscripten_glfw_make_canvas_resizable: _emscripten_glfw_make_canvas_resizable,
  /** @export */
