...
// end include: preamble.js
  ...
  var _emscripten_glfw3_context_open_url = (url, target) => {
      if(url) {
  ...
  var _emscripten_glfw3_window_change_focus = (glfwWindow, isFocussed) => {
...
var wasmImports = {
  ...
  /** @export */
  emscripten_glfw3_context_open_url: _emscripten_glfw3_context_open_url,
  /** @export */
  ...
  /** @export */
  emscripten_glfw3_window_change_focus: _emscripten_glfw3_window_change_focus,
  /** @export */
